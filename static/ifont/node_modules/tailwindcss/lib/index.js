...
var _registerConfigAsDependency = require('tailwindcss/lib/lib/registerConfigAsDependency');

var _registerConfigAsDependency2 = _interopRequireDefault(_registerConfigAsDependency);

var _processTailwindFeatures = require('tailwindcss/lib/processTailwindFeatures');

var _processTailwindFeatures2 = _interopRequireDefault(_processTailwindFeatures);

var _mergeConfigWithDefaults = require('tailwindcss/lib/util/mergeConfigWithDefaults');
...
const plugin = _postcss2.default.plugin('tailwind', config => {
  ...
  const getConfig = () => {
    ...
    return (0, _mergeConfigWithDefaults2.default)(_lodash2.default.isObject(config) ? config : require(_path2.default.resolve(config)), require('tailwindcss/defaultConfig')());
  };
