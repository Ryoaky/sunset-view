...
var _substituteTailwindAtRules = require('tailwindcss/lib/lib/substituteTailwindAtRules');

var _substituteTailwindAtRules2 = _interopRequireDefault(_substituteTailwindAtRules);

var _evaluateTailwindFunctions = require('tailwindcss/lib/lib/evaluateTailwindFunctions');

var _evaluateTailwindFunctions2 = _interopRequireDefault(_evaluateTailwindFunctions);

var _substituteVariantsAtRules = require('tailwindcss/lib/lib/substituteVariantsAtRules');

var _substituteVariantsAtRules2 = _interopRequireDefault(_substituteVariantsAtRules);

var _substituteResponsiveAtRules = require('tailwindcss/lib/lib/substituteResponsiveAtRules');

var _substituteResponsiveAtRules2 = _interopRequireDefault(_substituteResponsiveAtRules);

var _substituteScreenAtRules = require('tailwindcss/lib/lib/substituteScreenAtRules');

var _substituteScreenAtRules2 = _interopRequireDefault(_substituteScreenAtRules);

var _substituteClassApplyAtRules = require('tailwindcss/lib/lib/substituteClassApplyAtRules');

var _substituteClassApplyAtRules2 = _interopRequireDefault(_substituteClassApplyAtRules);

var _generateUtilities = require('tailwindcss/lib/util/generateUtilities');

var _generateUtilities2 = _interopRequireDefault(_generateUtilities);

var _processPlugins = require('tailwindcss/lib/util/processPlugins');
